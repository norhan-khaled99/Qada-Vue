<template>
  <div class="container m-auto">
    ...
    <span class="d-flex">
      ...
      <div class="card py-2 px-3">
        ...
        <div class="sub-title my-2">
          لدي استفسار بخصوص الاوراق الخاصة بالمشروع، هل يمكنك ان ترسل لي بيانات
          بخصوص إن كان عقد اخضر؟
        </div>
      </div>
    </span>
    ...
    <div class="col-md-8 col-sm-12 mt-5 d-flex me-5">
        ...
        <div class="card py-2 px-3 w-75">
          <div class="card-body-title">محمد حسنين
            <span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                <path d="M11.4946 2.71381C11.7012 2.29527 12.298 2.29527 12.5046 2.71381L15.1786 8.13194C15.2606 8.29814 15.4192 8.41334 15.6026 8.43999L21.5818 9.30883C22.0437 9.37595 22.2282 9.94357 21.8939 10.2694L17.5673 14.4868C17.4346 14.6162 17.374 14.8026 17.4053 14.9852L18.4267 20.9403C18.5056 21.4004 18.0228 21.7512 17.6096 21.534L12.2616 18.7224C12.0976 18.6361 11.9016 18.6361 11.7375 18.7224L6.38953 21.534C5.9764 21.7512 5.49355 21.4004 5.57245 20.9403L6.59383 14.9852C6.62516 14.8026 6.5646 14.6162 6.43187 14.4868L2.10525 10.2694C1.77102 9.94357 1.95545 9.37595 2.41734 9.30883L8.3966 8.43999C8.58001 8.41334 8.73857 8.29814 8.8206 8.13194L11.4946 2.71381Z" fill="#0C483F" stroke="#0C483F" stroke-width="2" stroke-linejoin="round"/>
              </svg></span>
        </div>
