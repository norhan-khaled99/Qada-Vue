    ...
    <div>
      ...
      <div class="container">
        ...
        <div v-for="project in filteredProjects" :key="project.id">
          <router-link :to="{ name: 'mainTabsForOffice', params: { id: project.id } }" class="card-link">
                ...
                <div class="card">
                  ...
                  <div class="row my-3">
                    <div class="col-md-3 col-sm-12 d-flex flex-column align-items-center">
                      ...
                      <div class="card-content mt-5" style="color:#C4A551;">
                    ...
                    <div class="col-md-3 col-sm-12 d-flex flex-column align-items-center">
                      ...
                      <div>
                        <span>{{ project.project_days_limit }} يوم عمل</span>
                      </div>
                      <div class="card-content mt-5">
                      ...
                      <div class="card-content">
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                          <path
                            ...
                            stroke="#C4A551" stroke-width="1.5" />
                          <path
                          ...
                          <path
                            ...
                            stroke="#C4A551" stroke-width="1.5" stroke-linecap="round" />
                        </svg>
