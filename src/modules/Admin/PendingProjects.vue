<template>
    ...
    <div v-for="project in  projects " :key="project.id" class="col-lg-8 m-auto my-5 p-1 card">
        <!-- <p>{{ result.data}}</p> -->
        <div class="">
            <div class="">
            ...
            <div class="d-flex mb-4">
                <div class="col-lg-3">
                    ...
                    <!-- <div class="card-content me-2">
                        ...
                        <span class="card-content-text me-2">المشاهدات</span>
                    </div>
                    <div>
                ...
                <div class="col-md-3 col-sm-12 ">
                    ...
                    <div>
                        <span class="subContent">(40) يوم عمل</span>
                    </div>
                    <div class="card-content">
                        ...
                        <span class="card-content-text me-2">العروض المستلمة</span>
                    </div>
                    <div>
        ...
        <div class="d-flex bg-danger">
            <div class="col-3">
                <img :src="project.title_deed" alt="صك الملكية"/>
            </div>
        </div>
        <div class="d-flex justify-content-center my-3">
            <button class="edit-button">تعديل</button>
            <button class="delete-button me-3">حذف</button>
        </div>
    </div>
</template>
