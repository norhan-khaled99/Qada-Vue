       ...
       <div class="row">
        ...
        <div class="col-md-4 col-sm-12 statics">
            ...
            <div class="d-flex justify-content-around mt-5">
                ...
                <div class="col-2  first-column-two ">
                   50%
                </div> 
    
                <div class="col-2  second-column-two">
                   91%
                </div>
                <div class="col-2 third-column-two " >
                    73%
                </div>
                </div>
        </div>
       ...
       <div class="row my-5">
        ...
        <div class="team-member-content bg-light mb-5">
          <div class="row align-self-baseline">
            <div class="col team-member-content-title">
                الموظف
            </div>
            <div class="col team-member-content-title">
                موعد التسليم
...
.first-column span, .first-column svg{
    margin: 1rem 0;
}
.second-column{
display: flex;
...
.second-column span, .second-column svg{
    margin: 1rem 0;
}
.third-column{
display: flex;
...
.third-column span, .third-column svg{
    margin: 1rem 0;
}
.team-member{
color: #E4E4E4;
