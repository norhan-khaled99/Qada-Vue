<template>
  <div class="container">
    <div class="header">
      <span class="header-color">(أعمال)</span>معلومات العميل
    </div>
    <div class="row">
      <div class="col-8 first-card mx-auto flex-column my-3 text-right">
        ...
        <div class="card-subtitle mb-5">احمد محمد</div>
        ...
        <div class="card-title">
          ...
          <span> اسم المهندس المكلف بمتابعة المشاريع في المنصة </span>
        </div>
        <div class="card-subtitle mb-5">محمود احمد</div>
        ...
        <div class="card-title">
          <span
            ><svg
              ...
              fill="none"
            >
              <g clip-path="url(#clip0_966_19601)">
                <path
              ...
              <defs>
                <clipPath id="clip0_966_19601">
                  <rect width="24" height="24" fill="white" />
                </clipPath>
              </defs>
            </svg>
          </span>
          <span>تاريخ انتهاء السجل التجاري</span>
        </div>
        <div class="card-subtitle mb-5">2/2/2022</div>
        ...
        <div class="card-subtitle mb-5">******************</div>
      </div>
    </div>
